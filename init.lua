...
vim.diagnostic.config {
  ...
  virtual_text = { prefix = '●' }, -- Text shows up at the end of the line
...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  callback = function() vim.hl.on_yank { timeout = 75 } end,
})
...
require('lazy').setup({
    ...
    keys = {
      {
        ...
        desc = '[O]pen session [R]estore',
      },
      {
        '<leader>ol',
        function() require('persistence').load { last = true } end,
        desc = '[O]pen session [L]ast',
      },
      {
        '<leader>od',
        function() require('persistence').stop() end,
        desc = '[O]pen session [D]isable save',
      },
    },
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ss', function() builtin.lsp_document_symbols {} end, { desc = 'Document symbols' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gt', builtin.lsp_type_definitions, 'Type Definitions')
